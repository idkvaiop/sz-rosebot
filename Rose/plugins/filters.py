...
from Rose.utils.filter_groups import chat_filters_group
...
Filters are case insensitive; every time someone says your trigger words, Akira will reply something else! can be used to create your own commands, if desired.
